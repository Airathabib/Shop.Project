...
import { setProducts, showLoadingList } from "../redux/listSlices";
import { ListCompnents } from "./List.css";

const { StyledList } = ListCompnents;
...
const List: React.FC = () => {
	...
	const productsNumber = useSelector((state: RootState) => state.listSlices.products.length);


	return (
		<StyledList>
			<p>Список товаров ({productsNumber})</p>
			<Filter />
			<div>
				{loading && <Loader />}
